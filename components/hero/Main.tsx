...
export default function Main() {
  ...
  return (
    <div className='w-10/12 mx-auto  p-3 shadow-md overflow-y-scroll '>
      <div className="order-line">
        <h1 className='font-bold py-2 text-2xl'>Order Line</h1>
        <div className="order-menus flex  gap-4">
        ...
        <div className="order-cards mt-4 gap-4  w-full gri md:grid grid-cols-4">
          <div className="card inline-flex flex-col  text-sm rounded-md px-4  gap-4 py-4 bg-[#C1EAE4]">
      ...
      <div className="">
      <h1 className='font-bold py-2 text-2xl'>Order Line</h1>
      <div className="foodCategories py-6 border-dashed border-b-[4px] border-[#F7F8FA] gap-2 grid grid-cols-5">
        <div className="cat-card border-green-200 bg-green-100 p-2 rounded-md border-1  flex gap-4">
        ...
        <div className="cat-card bg-green-100 p-2 rounded-md border-1 border-black flex gap-4">
          <Image src={'https://img.freepik.com/free-photo/pizza-pizza-filled-with-tomatoes-salami-olives_140725-1200.jpg?t=st=1711616121~exp=1711619721~hmac=e47db02aac23d429edee8eb7d43954901e697830abe7e5a3c82cfe7b75c92eca&w=740'} alt='' width={60} height={30} className='p-2 bg-[#F7F8FA] rounded-md'/>
          <div className="cat-details">
            <h2>All Media</h2>
            <p className='text-xs'>Available </p>
      ...
      <div className="foods-cards flex-wrap py-10 grid grid-cols-4 gap-5">
